...
<div class="page-wrapper">
    ...
    <header class="main-header">
        ...
        <div class="main-box">
            ...
            <div class="nav-outer">
                <div class="logo-box">
                    <div class="logo"><a href="index.php"><img src="images/logo.png" alt="" title="" height="53"width="150"></a></div>
                </div>
                ...
                <nav class="nav main-menu">
                    <ul class="navigation" id="navbar">
                        ...
                        <li>
                            <span><a href="dashboard/jobseeker/job-list.php">Find Jobs</a></span>
                        </li>

                        <li>
                            <span><a href="lists/candidates-list.php">Find Job Seeker</a></span>
                        </li>
                        <li>
        ...
        <div class="mobile-header">
            <div class="logo"><a href="index.php"><img src="images/logo.png" alt="" title="" height="54"width="77"></a></div>
...
<!-- Mirrored from creativelayers.net/themes/superio/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jan 2023 04:50:50 GMT -->
</html>