...
if (isset($_POST['ban']) && isset($_POST['del'])) {
    ...
    foreach ($delete as $value) {
        $sql = "UPDATE `jobseeker` SET `bantime`='$time',`bantimespan`='$timespan',`startdate`=curdate(),`starttime`=curtime() WHERE id=$value";
        $conn->query($sql);
        echo '<script>window.location.href = "Jobseeker.php"</script>';
    }
}
?>
...
<section class="main">
    <div class="sidebar">
        <ul class="sidebar--items">
            ...
            <li>
                <a href="Jobseeker.php" id="active--link">
    ...
    <div class="main--content">
        ...
        <div class="recent--patients">
            <div class="title">
                ...
                <h2 class="section--title">All Report of Jobseeker</h2>
            </div>
            <form method="post">
                <div class="title">
