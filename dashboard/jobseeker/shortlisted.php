            ...
            <div class="col-lg-12">
                ...
                <div class="applicants-widget ls-widget">
                    ...
                    <div class="widget-content">
                        <div class="row">
                            <?php
                            $sql = "SELECT * FROM `jobpost_apply` WHERE jid = $id AND status = 'a'";
                            $result = $conn->query($sql);
                            if ($result->num_rows > 0) {
                                ...
                                <div class="inner-box">
                                    ...
                                    echo '</span>
                                        <h4><a href="../../profile/jobpost.php?id='.$record['id'].'">';
                                    echo $record['title'];
                                    echo '</a></h4>
                                        <ul class="job-info">
                                ...
                                echo '<div class="job-block">
                                                    <div class="inner-box">
                                                        <div class="content">' . "You will Shortlist very soon.</div></div></div>";
                            }
                            ?>
                        </div>
                    </div>
