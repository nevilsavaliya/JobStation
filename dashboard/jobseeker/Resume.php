                ...
                <div class="outer-box">
                    ...
                    <div class="dropdown dashboard-option">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="Resume.php"><i
    ...
    <div class="user-sidebar">
        ...
        <div class="sidebar-inner">
            <ul class="navigation">
                ...
                <li class="active"><a href="Resume.php"><i class="la la-file-invoice"></i>My
                        Resume</a></li>
        ...
        <div class="dashboard-outer">
            ...
            <div class="col-lg-12">
                ...
                <div class="applicants-widget ls-widget">
                    <span class="widget-title">Your Resume:</span>
                    <div class="">
                        <?php
                        include '../../Connection_Module.php';
                        $sql = "SELECT resume FROM `jobseeker` WHERE id = $id";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $pdf = $row['resume'];
                        echo '<embed title="resume" src="data:application/pdf;base64,' . $pdf . '" type="application/pdf" width="800" height="600" filename="Hi" />';
                        ?>
                    </div>
                </div>
            </div>
