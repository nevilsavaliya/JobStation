                    ...
                    <div class="dropdown dashboard-option">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="list"><a href="Resume.php"><i
                                    ...
                                    Resume</a></li>
                            <li class="active"><a href="AppliedJob.php"><i
        ...
        <div class="sidebar-inner">
            <ul class="navigation">
                ...
                <li class="list"><a href="Resume.php"><i class="la la-file-invoice"></i>My
                        Resume</a></li>
                <li class="active"><a href="AppliedJob.php"><i class="la la-briefcase"></i> Applied
                        Jobs </a></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="applicants-widget ls-widget">
                    ...
                    <div class="widget-content">
                        <div class="row">
                            <?php
                            $sql = "SELECT * FROM `jobpost_apply` WHERE jid = $id";
                            $result = $conn->query($sql);
                            if($result->num_rows > 0){
                                ...
                                <div class="inner-box">
                                    ...
                                    echo '</li>
                                        ...
                                        <span style="text-align: right;"><a href="show-apply-job-module.php?id='.$value.'" class="theme-btn btn-style-one">Remove Job</a></span>
                                        </div>
                                    </div>
                                </div>
                                </div>';
                                ...
                                echo '<div class="job-block col-lg-6 col-md-12 col-sm-12">
                                                <div class="job-block">
                                                    <div class="inner-box">
                                                        <div class="content">Apply For Job First.</div></div></div></div>';
                            }
                            ?>
                        </div>
                    </div>
