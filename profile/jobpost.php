...
<!--                                    Alerts</a>-->
        ...
        <div class="mobile-header">
            ...
            <div class="nav-outer clearfix">
                ...
                <?php
                include '../Connection_Module.php';
                $sql = "select complete from $user where id=$id";
                $result = $conn->query($sql);
                $row = $result->fetch_array();
                if (!$row['complete']) {
                    echo '
                    ...
                    if ($row['image']) {
                        echo '
                            <button id="toggle-user-sidebar">
                                <img src="data:image/jpg;charset=utf8;base64,';
                        echo base64_encode($row['image']) . '"' . 'alt="avatar" class="thumb">
                                </button>
                            </a>';
                    }
                    ?>
    ...
    <?php
    $sql = "SELECT * FROM `jobpost` WHERE id = $postid";
    $post = $conn->query($sql);
    $post = $post->fetch_assoc();
    $sql = "SELECT * FROM `employer` WHERE id = " . $post['eid'];
    $employer = $conn->query($sql);
                    ...
                    <div class="content-column col-lg-8 col-md-12 col-sm-12">
                        <div class="job-block-outer">
                            ...
                            <div class="job-block-seven">
                                <div class="inner-box">
                                    <div class="content">
                                        <span class="company-logo"><?php echo '<img src="data:image/jpg;charset=utf8;base64,';
                                            echo base64_encode($employer['image']) . '"' . 'alt="avatar" class="thumb">'; ?></span>
                                        <h4><a href="#"><?php echo $post['title']; ?></a></h4>
                                        <ul class="job-info">
                                            <li>
                                                <span class="icon flaticon-briefcase"></span> <?php echo $post['category']; ?>
                                            </li>
                                            <li>
                                                <span class="icon flaticon-map-locator"></span> <?php echo $employer['city']; ?>
                                            </li>
                                            <li><span class="icon flaticon-clock-3"></span> 11 hours ago</li>
                                            <li>
                                                <span class="icon flaticon-money"></span> <?php echo $post['lsalary'] . "-" . $post['hsalary'] ?>
                                            </li>
                                        </ul>
                                        <ul class="job-other-info">
                                            <li class="time"><?php echo $post['jobtype']; ?></li>
                        ...
                        <div class="graph-widget ls-widget">
                            <div class="tabs-box">
                                <div class="widget-title">
                                    <h4>Present and Future Of This Job</h4>
                                </div>
                                ...
                                <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
                                    <div class="gm-style"
                                        ...
                                        <div tabindex="0" aria-label="Map" aria-roledescription="map" role="region"
                                             aria-describedby="4944A93E-5D49-45C5-8190-600F1C42C5CE"
                                            ...
                                            <div style="z-index: 1; position: absolute; left: 50%; top: 50%; width: 100%; will-change: transform; transform: translate(0px, 0px);">
                                                <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                                                    <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                                        <div style="position: absolute; z-index: 988; transform: matrix(1, 0, 0, 1, -70, -107);">
                                                ...
                                                <div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;">
                                                    <div style="width: 24px; height: 24px; overflow: hidden; position: absolute; left: -12px; top: -24px; z-index: 0;">
                                                        <img alt=""
                                                    ...
                                                    <div style="position: absolute; z-index: 988; transform: matrix(1, 0, 0, 1, -70, -107);">
                                                        <div style="position: absolute; left: -512px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3695!3i2513!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=101995"
                                                        ...
                                                        <div style="position: absolute; left: -512px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3695!3i2512!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=1152"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3697!3i2513!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=98067"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: -256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3696!3i2513!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=100031"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: -256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3696!3i2512!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=130259"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: 0px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3697!3i2512!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=128295"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: 256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3698!3i2512!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=126331"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: 256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3698!3i2513!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=96103"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: 256px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3698!3i2514!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=65875"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: 0px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3697!3i2514!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=67839"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: -256px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3696!3i2514!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=69803"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                        <div style="position: absolute; left: -512px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                            <img draggable="false" alt="" role="presentation"
                                                                 src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i12!2i3695!3i2514!4i256!2m3!1e0!2sm!3i658399381!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDaaCBm4FEmgKs5cfVrh3JYue3Chj1kJMw&amp;token=71767"
                                                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div style="z-index: 3; position: absolute; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; left: 0px; top: 0px; touch-action: pan-x pan-y;">
                                                <div style="z-index: 4; position: absolute; left: 50%; top: 50%; width: 100%; will-change: transform; transform: translate(0px, 0px);">
                                                    ...
                                                    <div style="position: absolute; left: 0px; top: 0px; z-index: 106; width: 100%;">
                                                        <span id="3A07F7B5-A811-4D26-91F2-4C25B25C4D4B"
                                                              style="display: none;">To navigate, press the arrow keys.</span>
                                                        <div title="Envato" aria-label="Envato" role="button"
                                                             tabindex="0"
                                                             aria-describedby="3A07F7B5-A811-4D26-91F2-4C25B25C4D4B"
                                                             style="width: 24px; height: 24px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -12px; top: -24px; z-index: 0;">
                                                            <img alt=""
                                                                 src="http://maps.gstatic.com/mapfiles/transparent.png"
                                                                 draggable="false"
                                            ...
                                            <div class="LGLeeN-keyboard-shortcuts-view"
                                                 id="4944A93E-5D49-45C5-8190-600F1C42C5CE" style="display: none;">
                                                <table>
                                                    <tbody>
                                                    <tr>
                                        ...
                                        <div>
                                            <div style="margin: 0px 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;">
                                                <a target="_blank" rel="noopener"
                                                   ...
                                                   href="https://maps.google.com/maps?ll=-37.817085,144.955631&amp;z=12&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
                                        ...
                                        <div>
                                            <div style="display: inline-flex; position: absolute; right: 0px; bottom: 0px;">
                                                ...
                                                <div class="gmnoprint" style="z-index: 1000001;">
                                                    <div draggable="false" class="gm-style-cc"
                                                        ...
                                                        <div style="position: relative; padding-right: 6px; padding-left: 6px; box-sizing: border-box; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(0, 0, 0); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;">
                                                            ...
                                                            <span style="">Map data ©2023</span></div>
                                                    </div>
                                                </div>
                                                ...
                                                <button draggable="false" aria-label="Map Scale: 2 km per 66 pixels"
                                                        title="Map Scale: 2 km per 66 pixels" type="button"
                                                        class="gm-style-cc"
                                                        aria-describedby="4F36F5C6-FB47-4733-B6A2-44D196357B48"
                                                    ...
                                                    <div style="position: relative; padding-right: 6px; padding-left: 6px; box-sizing: border-box; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(0, 0, 0); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;">
                                                        <span>2 km&nbsp;</span>
                                                        <div style="position: relative; display: inline-block; height: 8px; bottom: -1px; width: 70px;">
                                                    ...
                                                    <span id="4F36F5C6-FB47-4733-B6A2-44D196357B48"
                        ...
                        <div class="related-jobs">
                            ...
                            <?php
                            $sql = "SELECT * FROM `jobpost_skill` WHERE id = " . $postid;
                            $postskillarr = $conn->query($sql);
                            $skillmatchpostid = [];
                            while ($postskill = $postskillarr->fetch_assoc()) {
                                $sql = "SELECT * FROM `jobpost_skill` WHERE NOT id = " . $postid . " AND skill = '" . $postskill['skill'] . "'";
                                $skillmatchpostidarr = $conn->query($sql);
                                while ($skillmatchpostidvalue = $skillmatchpostidarr->fetch_array()) {
                                    $skillmatchpostid[] = $skillmatchpostidvalue['id'];
                                }
                            }
                            if ($skillmatchpostid != null) {
                                $skillmatchpostid = array_unique($skillmatchpostid);
                            }
                            ?>
                            ...
                            <div class="row">
                                <?php
                                if ($skillmatchpostid != null) {
                                    foreach ($skillmatchpostid as $value) {
                                        $sql = "SELECT * FROM `jobpost` where id = " . $value;
                                        $postarr = $conn->query($sql);
                                        while ($jobpost = $postarr->fetch_assoc()) {
                                            echo ' <div class="job-block-four col-lg-6 col-md-6 col-sm-12"><a href="../profile/jobpost.php?id=' . $jobpost['id'] . '">
                                        <div class="inner-box">
                                            <ul class="job-other-info">
                                                <li class="time">' . $jobpost['jobtype'] . '</li>';
                                            $sql = "SELECT * FROM `jobpost_skill` where id = " . $jobpost['id'];
                                            $postskillarr = $conn->query($sql);
                                            while ($postskill = $postskillarr->fetch_assoc()) {
                                                echo '<li class="privacy">' . $postskill['skill'] . '</li>';
                                            }
                                            echo '</ul>';
                                            $sql = "SELECT * FROM `employer` where id = " . $jobpost['eid'];
                                            $skillemployerarr = $conn->query($sql);
                                            $skillemployer = $skillemployerarr->fetch_assoc();
                                            echo '<span class="company-logo">';
                                            echo '<img src="data:image/jpg;charset=utf8;base64,';
                                            echo base64_encode($skillemployer['image']) . '"';
                                            echo 'alt="avatar" class="logo">';
                                            echo '</span>
                                            <span class="company-name">' . $skillemployer['name'] . '</span>
                                            <h4><a href="#">' . $jobpost['title'] . '</a></h4>
                                            <div class="location"><span class="icon flaticon-map-locator"></span>' . $jobpost['address'] . '</div>
                                        </div>
                                    </div></a>';
                                        }
                                    }
                                    ...
                                    echo '<div class="job-block">
                                                    <div class="inner-box">
                                                        <div class="content">' . "Another Job Is Not For You Yet.</div></div></div>";
                                }
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="sidebar-column col-lg-4 col-md-12 col-sm-12">
                        <aside class="sidebar">
                            ...
                            if($user == "jobseeker") {
                                ...
                                <a href="../dashboard/jobseeker/apply-job-module.php?id='.$postid.'" class="theme-btn btn-style-one">Apply For Job</a>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="job-overview">
                                        ...
                                        <li>
                                            ...
                                            <span><?php echo $post['deadline'] ?></span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <h5>Rate:</h5>
                                            <span><?php echo "$" . round(($post['lsalary'] / 8640), 2) . " - $" . round(($post['hsalary'] / 8640), 2) . " Salary"; ?></span>
                                        </li>
                                        <li>
                                            <i class="icon icon-salary"></i>
                                            <h5>Salary:</h5>
                                            <span><?php echo "$" . $post['lsalary'] . " - $" . $post['hsalary'] ?></span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="widget-content">
                                    <ul class="job-skills">
                                        ...
                                        $skillarr = $conn->query($sql);
                                        while ($skill = $skillarr->fetch_assoc()) {
                                            echo '<li><a href="#">' . $skill['skill'] . '</a></li>';
                                        }
                                        ?>
                                    </ul>
                                </div>
                            ...
                            <div class="sidebar-widget company-widget">
                                <div class="widget-content">
                                    <div class="company-title">
                                        <div class="company-logo"><?php echo '<img src="data:image/jpg;charset=utf8;base64,';
                                            echo base64_encode($employer['image']) . '"' . 'alt="avatar" class="thumb">'; ?></div>
                                        <h5 class="company-name"><?php echo $employer['name']; ?></h5>
                                        <a href="employer.php?id=<?php echo $employer['id']; ?>" class="profile-link">View
                                            company profile</a>
                                    </div>
                                </div>
                            </div>
...
while ($post = $postarray->fetch_assoc()) {
    $postid = $post['id'];
    $dataset[0] = getPostApplyCount($conn, $postid, 4);
    $dataset[1] = getPostApplyCount($conn, $postid, 3);
    $dataset[2] = getPostApplyCount($conn, $postid, 2);
    $dataset[3] = getPostApplyCount($conn, $postid, 1);
    $predictWeek = 5;
    ...
    $dataset[4] = round($predictedJobCount);
    $predictWeek = 6;
    $predictedJobCount = $regression->predict($predictWeek);
    $dataset[5] = round($predictedJobCount);
    $predictWeek = 7;
    $predictedJobCount = $regression->predict($predictWeek);
    $dataset[6] = round($predictedJobCount);
    $predictWeek = 8;
    $predictedJobCount = $regression->predict($predictWeek);
    $dataset[7] = round($predictedJobCount);
}
?>
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#1967D2',
                borderWidth: "1",
                data: <?php echo "[$dataset[0], $dataset[1], $dataset[2], $dataset[3], $dataset[4], $dataset[5], $dataset[6], $dataset[7]]"; ?>,
                pointRadius: 3,
                pointHoverRadius: 3,
                pointHitRadius: 10,
